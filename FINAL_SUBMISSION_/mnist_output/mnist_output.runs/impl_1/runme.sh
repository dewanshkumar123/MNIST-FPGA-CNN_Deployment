...
HD_PWD='D:/IIT CLASSES/SEM_4/DIGITAL SYSTEMS/3D_CNN/Project Repo/3D_CNN_FPGA/BRAM_IMPLEMENT/mnist_output/mnist_output.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_op.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mnist_op.tcl -notrace

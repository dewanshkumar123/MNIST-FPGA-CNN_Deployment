...
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { AN[1] }]; # Specify I/O standard for AN[1]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { AN[2] }]; # Specify I/O standard for AN[2]
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { AN[3] }]; # Specify I/O standard for AN[3]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { AN[4] }]; # Specify I/O standard for AN[4]
set_property -dict { PACKAGE_PIN T14    IOSTANDARD LVCMOS33 } [get_ports { AN[5] }]; # Specify I/O standard for AN[5]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { AN[6] }]; # Specify I/O standard for AN[6]
set_property -dict { PACKAGE_PIN U13    IOSTANDARD LVCMOS33 } [get_ports { AN[7] }]; # Specify I/O standard for AN[7]

set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { wr_uart }]; # Specify I/O standard for wr_uart
set_property -dict { PACKAGE_PIN P17    IOSTANDARD LVCMOS33 } [get_ports { rd_uart }]; # Specify I/O standard for rd_uart
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { reset_n }]; # Specify I/O standard for reset_n
set_property -dict { PACKAGE_PIN C4   IOSTANDARD LVCMOS33 } [get_ports { rx }]; # Specify I/O standard for rx

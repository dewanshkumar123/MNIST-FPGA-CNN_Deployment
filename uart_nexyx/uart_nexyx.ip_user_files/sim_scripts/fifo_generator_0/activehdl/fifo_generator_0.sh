...
#
# Generated by Vivado on Wed Mar 13 22:08:16 +0530 2024
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Different/Semester-4/Digital Systems/uart_nexyx/uart_nexyx.cache/compile_simlib/activehdl"
  fi

...
HD_PWD='C:/Different/Semester-4/Digital Systems/uart_nexyx/uart_nexyx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log terminal_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source terminal_demo.tcl -notrace

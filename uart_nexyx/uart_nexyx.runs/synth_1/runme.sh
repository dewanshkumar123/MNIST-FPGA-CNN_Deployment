...
HD_PWD='C:/Different/Semester-4/Digital Systems/uart_nexyx/uart_nexyx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log terminal_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source terminal_demo.tcl
